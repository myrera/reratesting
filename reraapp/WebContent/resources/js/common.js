...
// Below two lines Commented for "back to list" link
...
function bindfileupload(){
	...
	var msg="Allowed file size exceeded. (Max. 1 MB)";
	if($(this).hasClass('fiveMBsizefile')){
		maxsize=(1024*1024*5);
	msg=	"Allowed file size exceeded. (Max. 5 MB)"
	}else if($(this).hasClass('tenMBsizefile')){
		maxsize=(1024*1024*10);
	msg=	"Allowed file size exceeded. (Max. 10 MB)"
	}
	else if($(this).hasClass('thirtyMBsizefile')){
		maxsize=(1024*1024*30);
	msg=	"Allowed file size exceeded. (Max. 30 MB)";
	}
	else if($(this).hasClass('fiftyMBsizefile')){
		maxsize=(1024*1024*50);
	msg=	"Allowed file size exceeded. (Max. 50 MB)";
	}else{
...
$(st).find('.dynaselectSpn').each(function(){
	$(this).html('');
