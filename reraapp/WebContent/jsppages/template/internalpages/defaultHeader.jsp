							...
							class="icon-bar"></span>
                                    ...
                                    <div id="navbar" class="navbar-collapse collapse">
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li><a href="<%=request.getContextPath() %>/projectsUnderInvestigation">Projects under Investigation<b><font style="vertical-align:super;font-size:8px;color:yellow"></font></b></a></li>
                                            <li><a href="<%=request.getContextPath() %>/checkRegisteredProjects">Report Unregistered Projects<b><font style="vertical-align:super;font-size:8px;color:yellow"></font></b></a></li>
                                            <li><a href="<%=request.getContextPath() %>/helpdeskLoginPage">Help Desk<b><font style="vertical-align:super;font-size:8px;color:yellow"></font></b></a></li>
                                        ...
                                        <%--  <li><a href="<%=request.getContextPath() %>/viewApprovedProjectsInHomePage"> List of Projects </a>
                                            ...
                                            <%--   <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Downloads <span class="caret"></span></a>
                                                ...
                                                <%-- <li><a href="<%=request.getContextPath() %>/resources/notices.pdf" target="new">List Of Projects </a>
                                                    ...
                                                    <li><a href="<%=request.getContextPath() %>/viewApprovedProjectsInHomePage"> Projects List </a></li>
                                                    ...
                                                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Communication<span class="caret"></span></a>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="<%=request.getContextPath() %>/resources/staticpage/press_release.pdf" target="_blank">Press release</a></li>
