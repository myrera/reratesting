	    ...
	    <center>
	        ...
	        <form id="sendEmailForm" method="post" action="sendEmail" enctype="multipart/form-data">
	            <table id="emailFormBeanTable" border="0" width="80%">
	                ...
	                <tr>
	                    <td>Attachment: </td>
	                    <td><input id="mailAttachment" type="file" class="form-control requiredValFld thirtyMBsizefile" rel="txtTooltip" title="Only image or pdf file is allowed. file size upto 30 MB" data-toggle="tooltip" data-placement="bottom"  id="approvedLayoutPlanFile" name="attachFileObj" size="60" /></td>
	                </tr>
	                <tr>
