...
<span class="pull-right user_name">Ack Number :<b>
						...
						<br>
				<span class="pull-right user_name">Company / Firm Name :<b> ${agent.agentDetailsModel.agentName}</b></span><br>
...
<form name="trxForm" autocomplete="off" action="revokeAgentRegistration" method="post" >
...
<div class="button-wrapper">
   ...
   <input name="btn1"  class="btn-style" id="editDocButton" value="Revoke Registration" type="button" onclick="revokeRegistration()"/>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <input name="btn1" class="btn-style" value="Enquiry" type="button"  onclick="sendEnquiry()"/>
