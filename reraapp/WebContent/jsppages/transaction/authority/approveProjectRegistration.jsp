<%@page import="in.gov.rera.common.security.ReraSecurity"%>
	...
	to List</a>
                    ...
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        <div class="Main_containner">
                            ...
                            <form name="approvalForm" id="approvalFormId" autocomplete="off" class="form-horizontal" action="approveProjectRegistration" method="post">
                                        ...
                                        <div class="tab-content">
                                            <div id="home" class="tab-pane fade in active">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                                        <p>
                                                            <a href='<%=request.getContextPath() %>/download?DOC_ID=${project.promoterDetailsModel.individualPhotoGraphPath.documentId}'>${project.promoterDetailsModel.individualPhotoGraphPath.fileName}</a>
                                                        </p>
                                                    </div>
                                                </div>
		...
		<div class="col-md-3 col-sm-6 col-xs-6" ><p> ${project.projectDetailsModel.longitude} </p></div>
                                                    ...
                                                    <div class="inner_wrapper">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                                <p>
                                                                    <a href="<%=request.getContextPath() %>/download?DOC_ID=${project.projectDetailsModel.delayedCertDoc.documentId}">
		...
		<div class="col-md-3 col-sm-6 col-xs-6" ><p><a href='<%=request.getContextPath() %>/download?DOC_ID=${project.projectDocModel.projectRelatedDoc.documentId}'>${project.projectDocModel.projectRelatedDoc.fileName }</a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                                        <p class="text-right">
                                                            Collaboration Agreement/Development Agreement/Joint Development Agreement/Other Agreement<span class="space_LR">:</span>
                                                        </p>
                                                    </div>
                                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                                        <p>
	...
	<div class="row"> -->
	 ...
	 <div class="row"> -->
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <p>
                                                    <a href='<%=request.getContextPath() %>/download?DOC_ID=${project.projectAddDocModel.bangaloreUrbanArtsCommission.documentId}'>${projectprojectReg.projectAddDocModel.bangaloreUrbanArtsCommission.fileName }</a>
                                                </p>
                                            </div>
	...
	<div class="row"> -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <p>
                                                    <a href='<%=request.getContextPath() %>/download?DOC_ID=${project.projectAddDocModel.coastalRegulationZoneAuthority.documentId}'>${projectReg.projectAddDocModel.coastalRegulationZoneAuthority.fileName }</a>
                                                </p>
                                            </div>
	...
	<div class="row"> -->
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <p class="text-right">
                                                    Certificate from Registered Engineer indicating the structural safety of the building (for Apartments)<span class="space_LR">:</span>
                                                </p>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <p>
                        ...
                        <div class="inner_wrapper">
                            ...
                            <c:forEach items="${project.projectPhotoDetailSet}" var="projectPhoto">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                        <p>
                                            <a href='<%=request.getContextPath() %>/download?DOC_ID=${projectPhoto.documentId}'>${projectPhoto.documentName}</a>
                                        </p>
                                    </div>
     ...
     <div class="col-md-3 col-sm-6 col-xs-6" ><p><a href='<%=request.getContextPath() %>/download?DOC_ID=${project.projectDocModel.auditedBalSheetYear2.documentId}'>${project.projectDocModel.auditedBalSheetYear2.fileName }</a>
                    ...
                    <div class="inner_wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <p>
                                    <a href='<%=request.getContextPath() %>/download?DOC_ID=${project.paymentDetailsModel.penaltyPaidReceipt.documentId}'>${project.paymentDetailsModel.penaltyPaidReceipt.fileName}
										</a>
                                </p>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
							...
							<div class="col-md-3 col-sm-6 col-xs-6">
							<select name ="verificationStatus" id='verificationStatus' class="form-control requiredValFld" style="width:100px;">
								<option value="0"> --Select-- </option>
								<option value="OK" >OK </option>
								<option value="NOT OK" > NOT OK </option>
							</select>
							<span class='requiredValFldMsg'> Please Select Verification Status.</span>
							</div>
							</br>
                    ...
                    <%=ReraSecurity.writeToken(request)%>
                        ...
                        <div class="button-wrapper">
                            <c:if test="${project.status=='PENDING_AUTHORITY'}">
                                <!-- editAgentUploadDoc -->
                                <input name="btn1" class="btn-style" value="Return" type="button" data-toggle="modal" data-target="#returnModal" /> <input name="btn1" class="btn-style" id="editocButton" value="Save" type="button" onclick="saveTrxForm()"
                                />
                                ...
                                <input name="btn1" class="btn-style" id="editDocButton" value="Forward" type="button" onclick="submitTrxForm('FORWARD')" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                    ...
                                    onclick="submitTrxForm('PREPARE_APPROVAL')" />
                                     ...
                                     <input name="btn1" class="btn-style" value="Reject" type="button"
                            ...
                            <div class="modal fade" id="returnModal" role="dialog">
								...
								Accounts <sup>*</sup>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="subject" onclick="setVal(this);" value="account" />
								...
								Revenue <sup>*</sup>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="subject" onclick="setVal(this);" value="revenue" />
								...
								TCP <sup>*</sup>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="subject" onclick="setVal(this);" value="tcp" />
								...
								Engineer <sup>*</sup>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" name="subject" onclick="setVal(this);" value="engineer" />
                                                ...
                                                <div class="button-wrapper">
                                                    ...
                                                    <input name="btn3" class="btn-style" value="Return" type="button" onclick="returnTrxForm()" />
