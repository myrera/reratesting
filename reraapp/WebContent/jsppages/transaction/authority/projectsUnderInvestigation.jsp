...
<div class="breadcrumb">Home / Project Under Investigation</div>
		...
		<div id="exTab2" class="container">
			...
			<font color='red'>
				<h1 style='color: red !important'>
					...
					with RERA and are under INVESTIGATION.<br> <br> The
					Public is warned that dealing with these projects is at their own
					risk as these are not registered with RERA."
				</h1>
			</font><br>
