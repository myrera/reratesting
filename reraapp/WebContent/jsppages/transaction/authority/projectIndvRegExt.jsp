...
<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right ">Firm Type <span class="space_LR">:</span></p></div>
...
<form name="approvalForm" autocomplete="off" action="approvedProjectExtRegistration" class="form-horizontal"  method="post">
