...
$(document).ready(function() {
	var t=$('#agentList').DataTable({"columnDefs": [ {
        "searchable": false,
        "orderable": false,
        "targets": 0
    } ],
...
<div class="breadcrumb">Home /Agent Rejected Task List</div>
...
<h1> Agent Rejected<span>Task List</span></h1>
<div class="drop_shadow"></div>
	<div class="clearfix"></div>
<h1>Total Requests : ${totalRecords} </h1>
