<%@page import="in.gov.rera.common.security.ReraSecurity"%>
                                            ...
                                            <div id="menu2" class="tab-pane fade">
												...
												${project.projectDocModel.extendedSacPlanDoc.fileName} </a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                            <p class="text-right">
                                                                NOC in case of building proposals abutting to neighbouring properties <span class="space_LR">:</span>
                                                            </p>
                                                        </div>
                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                            <p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                            <p>
                                                                <a href='<%=request.getContextPath() %>/download?DOC_ID=${projeprojectctReg.projectAddDocModel.urbanLandCeiling.documentId}'>${project.projectAddDocModel.urbanLandCeiling.fileName }</a>
                                                            </p>
                                                        </div>
     ...
     <div class="col-md-3 col-sm-6 col-xs-6" ><p><a href='<%=request.getContextPath() %>/download?DOC_ID=${project.projectDocModel.auditedBalSheetYear2.documentId}'>${project.projectDocModel.auditedBalSheetYear2.fileName }</a>
                                                            ...
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div id="${enq.enquiryId}" class="panel-collapse collapse in">
                                                                    <div class="panel-body">
                                                                        Subject: ${enq.subject}<br> <br> ${enq.enquiryText} <br>
                                    ...
                                    <%=ReraSecurity.writeToken(request)%>
                                        ...
                                        <div class="button-wrapper">
                                            ...
                                            <!-- editAgentUploadDoc -->
                                            <input name="btn1" class="btn-style" id="editDocButton" value="Reject" type="button" data-toggle="modal" data-target="#rejectModal" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="btn1" class="btn-style" value="Enquiry"
                                                type="button" data-toggle="modal" data-target="#myModal" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input name="btn1" class="btn-style" value="Move to Approval Queue" type="button"
	...
	function submitTrxForm(_out) {
		...
		if (_out == 'REJECTED') {
			...
			if (confirm('Do you want to return the application to the authority ?')) {
