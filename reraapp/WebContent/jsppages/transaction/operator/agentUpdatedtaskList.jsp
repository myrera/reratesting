...
$(document).ready(function() {
	var t=$('#agentUpdateTasklist').DataTable({"columnDefs": [ {
        "searchable": false,
        "orderable": false,
        "targets": 0
    } ],
...
<h1>Total Pending Requests : ${agentUpdatedPendingCount} </h1>
<div class="table-responsive">
				
				
				<table class="table table-bordered" id="agentUpdateTasklist">
        <thead>
            <tr>
            <th>S.NO</th>
