...
<div class="col-md-12 col-sm-12 ">
	...
	<div class="Main_containner">
		...
		<div class="col-md-3 col-sm-6 col-xs-6" ><p><a href='<%=request.getContextPath() %>/download?DOC_ID=${project.projectDocModel.projectRelatedDoc.documentId}'>${project.projectDocModel.projectRelatedDoc.fileName }</a> </p></div> --%>
								...
								<%-- <div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Conversion Certificate under Sec 95 of the KLR Act 1961 <span class="space_LR">:</span></p></div>
		<div class="col-md-3 col-sm-6 col-xs-6" ><p><a href='<%=request.getContextPath() %>/download?DOC_ID=${project.projectAddDocModel.section95.documentId}'>${project.projectAddDocModel.section95.fileName }</a></p></div>
								...
								<%-- <div class="row">
		<div class="col-md-3 col-sm-6 col-xs-6"><p class="text-right">Approval/NOC under section 109 of KLR Act 1961 <span class="space_LR">:</span></p></div>
								...
								<div class="row">
									<div class="col-md-3 col-sm-6 col-xs-6">
										<p class="text-left">
											...
											structural safety of the building (for Apartments) (1 MB)<span
												class="space_LR">:</span>
										</p>
									</div>
									<div class="col-md-3 col-sm-6 col-xs-6">
	 ...
	 --%>
						...
						<c:if test="${not empty project.enquiryList && not empty project.updatedFlag}">
						  ...
						  <c:if test="${project.status=='PENDING_OPERATOR'}">
							...
							<div class="col-md-3 col-sm-6 col-xs-6">
											<p class="text-right">
												Remarks <span class="space_LR">:</span>
											</p>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
						...
						<%--  <c:if test="${project.status!='PENDING_OPERATOR'}">
                            <h1>Application is not pending with Operator</h1>
                        </c:if> --%>
