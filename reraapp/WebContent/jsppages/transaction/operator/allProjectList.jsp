...
<h1> View All Projects <span>List</span></h1>
...
<div class="table-responsive">
	  ...
	  <td><a href="viewAllProjectDetails?PROJECT_ID=${obj.projectRegId}"> ${obj.applicationNo }</a></td>
           
<%--    <%if( !(user.getAuthorityType().equals("OP_ACCOUNTS" )) ){%>
...
<%} %> --%>
                ...
                <c:if test="${obj.status=='REJECTED'}">
                <td><a href="rejectReasonDocForm?PROJECT_ID=${obj.projectRegId}">${obj.status }</a></td>
