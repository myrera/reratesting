...
<h1>Enquiry Task List<span>(Approved)</span></h1>
...
<div class="table-responsive">
        ...
        <c:forEach items="${projectEnqApprovedList}" var="obj">
            <tr>
             <td><%= ++count %></td>
             <td>${obj.projectRegistrationNo }</td>
                ...
                <td><a href="projectDetails?PROJECT_ID=${obj.projectRegId}"> ${obj.promoterDetailsModel.promoterName }</a></td>
