...
<form:form class="form-horizontal" autocomplete="off" action="agentRegUpload" id="agenttrxForm1" method="POST" modelAttribute="agentRegistrationModel"    enctype="multipart/form-data" >
