					...
					<form:form class="form-horizontal" autocomplete="off"
						...
						<div class="card-block">
							<table class="table table-bordered  table-condensed" id="consCost-list">
								...
								<% int costCount = -1; %>
							 <c:choose>
												<c:when test="${ empty projectRegistrationModel.projectDetailsModel.constructionCostModel.constructionCostList}">
												...
												<c:otherwise>
												<%-- <input type="hidden" name="projectScheduleId" value="${projectRegistrationModel.projectDetailsModel.constructionCostDetails.projectScheduleId}" /> --%>
											    	...
											    	<td><input type="text" name="estTotConstructionCost" value="${projectRegistrationModel.projectDetailsModel.constructionCostModel.estTotConstructionCost}" readonly="true" class="form-control requiredValFld totalEstConstructionval" /><span
													class='requiredValFldMsg'> Please Enter Estimated Construction Cost</span></td>
					 ...
					 <input type="button" class="btn btn-sm btn-Primary  pull-right" id="btn-add-consCost" value="Add More" />	 
							...
							<p style="text-align:left"><font color="red">* Note : This certificate is regarding project cost estimation. The format of the certificate is available in the Download section under Certificates for Post Registration.</font></p>
                                    <c:choose>
										<c:when test="${not empty projectRegistrationModel.projectDetailsModel.constructionCostModel}">
										<div class="add-more" style="border-style: ridge; padding: 20px; background-color: #F8F8F8;">
											<div>
												 <input type="hidden"
													value="${projectRegistrationModel.projectDetailsModel.constructionCostModel.constructionCostModelId }"
													name="constructionCostModelId" /> 
													</div>
												...
												value="${projectRegistrationModel.projectDetailsModel.constructionCostModel.totProjectCost}"
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="hidden" name="certIssuedDocId" value="${projectRegistrationModel.projectDetailsModel.constructionCostModel.certFromChartedAcc.documentId}" />
													<input type="file" id="certFromChartedAcc" name="certFromChartedAcc"
														title="Only image or pdf file is allowed. file size upto 1 MB">
														<div class="col-md-9">
													<a href='<%=request.getContextPath() %>/download?DOC_ID=${projectRegistrationModel.projectDetailsModel.constructionCostModel.certFromChartedAcc.documentId}'>
														${projectRegistrationModel.projectDetailsModel.constructionCostModel.certFromChartedAcc.fileName}</a>
												</div>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="hidden" name="certIssuedStructuralEngDocId" value="${projectRegistrationModel.projectDetailsModel.constructionCostModel.certificateIssuedByStructuralEng.documentId}" />
													<input type="file" id="certificateIssuedByStructuralEng"
														name="certificateIssuedByStructuralEng"
														title="Only image or pdf file is allowed. file size upto 1 MB">
														<div class="col-md-9">
													<a
														href='<%=request.getContextPath() %>/download?DOC_ID=${projectRegistrationModel.projectDetailsModel.constructionCostModel.certificateIssuedByStructuralEng.documentId}'>
														${projectRegistrationModel.projectDetailsModel.constructionCostModel.certificateIssuedByStructuralEng.fileName}</a>
												</div>
											</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="hidden" name="certIssuedArcDocId"
														value="${projectRegistrationModel.projectDetailsModel.constructionCostModel.certificateIssuedByArchitect.documentId}" />
													<input type="file" id="certificateIssuedByArchitect"
														name="certificateIssuedByArchitect"
														title="Only image or pdf file is allowed. file size upto 1 MB">
														<div class="col-md-9">
													<a
														href='<%=request.getContextPath() %>/download?DOC_ID=${projectRegistrationModel.projectDetailsModel.constructionCostModel.certificateIssuedByArchitect.documentId}'>
														${projectRegistrationModel.projectDetailsModel.constructionCostModel.certificateIssuedByArchitect.fileName}</a>
												</div>
											</div>
											</div>	
											</div>	
																		<br> <a href="<%=request.getContextPath()%>/project/projectViewSummry" style="padding-left: 400px;"> 
					<input type="button" class="btn btn-sm btn-primary" width="50px;" id="ViewSummary"
								value="View Summary" /> </a>
							<br/>
													</c:when>
										<c:otherwise>
							...
							<div class="add-more" style="border-style: ridge; padding: 20px; background-color: #F8F8F8;">
								...
								</span> <input type="button" class="btn btn-sm btn-success  pull-right"
									style="width: 150px;" id="constructionCostId" value=" Save" />
							</div>
