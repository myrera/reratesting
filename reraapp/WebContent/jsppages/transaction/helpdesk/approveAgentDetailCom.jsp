...
<a class="pull-right user_name" href="javascript:history.back()">Back to List</a></br>
...
<!--    <input name="btn1"  class="btn-style" id="editDocButton" value="Forward" type="button" onclick="submitTrxForm('FORWARD')"/> -->
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <input name="btn1" class="btn-style disable_btn" value="Approve" type="button"   />
...
-->
  ...
  <% if(roleAccess!=null && roleAccess.equals("READ")){%>
 <div class="button-wrapper">
     <input name="btn3" class="btn-style disable_btn" value="Reject" type="button" />
     <button type="button" class="close" data-dismiss="modal">Close</button>
 </div>
 <%}else{  %>
 <div class="button-wrapper">
