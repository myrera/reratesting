...
<h1 >Help Desk</h1>
	<p>
	Please login or register to post your enquiries with department.<br/></br>
	
	Click here for
	<a href="<%=request.getContextPath() %>/resources/staticpage/Helpdesk User Manual v2.0.pdf" target="_blank">HelpDesk User Manual</a>
	</p>
	<br><br>
...
<form:form class="form-horizontal login" method="post" action="helpdeskLogin"  id="loginFormID" name="loginForm" autocomplete="off" >
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-9">
      <input name="btn1" class="btn-style" value="Login" type="button" onclick="loginUser();" />
       &nbsp;&nbsp;&nbsp;&nbsp;    <a href="helpdeskNewUser">New User ?</a>
