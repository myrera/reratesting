		...
		<div class="Main_containner">
			...
			<div class="inner_wrapper">
				...
				<form:form class="form-horizontal" method="post"
					action="helpdeskRegistration" id="loginFormID" name="registrationForm"
					 >
					...
					<div class="form-group  has-feedback ">
						...
						<div class="col-sm-9">
							<select name="type" id='type'
								...
								<option value="PROJECT">Promoter - Existing User</option>
								<option value="AGENT">Agent - Existing User</option>
								<option value="PROJECT UNREGISTERED">Promoter - New User</option>
								<option value="AGENT UNREGISTERED">Agent - New User</option>
								<option value="COMPLAINANT">Complainant  - Existing User</option>
								<option value="COMPLAINANT">Complainant - New User</option>
						...
						<div class="form-group has-feedback" hidden="true" id="phoneDiv">
					...
					<div class="form-group has-feedback" hidden="true" id="emailDiv">
						<label for="inputPassword3" class="col-sm-3 control-label">Email
							Address </label>
						<div class="col-sm-9">
							<input type="text" class="form-control requiredValFld" name="email"
