...
<form:form class="form-horizontal" action="${pageContext.request.contextPath}/changePassword" autocomplete="off"  method="post" name="changePass" id="changePass">
    ...
    <div class="border"><div class="orange"></div><div class="black"></div></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
				 <input type="hidden" name="loginId" value="<%=user.getLoginId() %>">
				  <input type="text" name="oldPassword" class="form-control input-sm" id="oldPassword"  autocomplete="new-password" placeholder="" >
				</div>
			...
			<div class="form-group">		
				...
				<div class="col-sm-3">
				<input type="password" name="new_password" class="form-control input-sm" id="new_password"  autocomplete="new-password" placeholder="">
				</div>						
	</div>								
			...
			<div class="form-group">		
				...
				<div class="col-sm-3">
				<input type="password" name="conFirmPassword" class="form-control input-sm" id="conFirmPassword"  autocomplete="new-password" placeholder="">
				</div>						
	</div>								
