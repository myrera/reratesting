...
<div class="row">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-6"><p><a href='<%=request.getContextPath() %>/download?DOC_ID=${agentReg.agentDetailsModel.photograph.documentId }' >${agentReg.agentDetailsModel.photograph.fileName}</a></p></div>
