...
<p>In accordance with Rule 15 of RERA Rules 2017, Publication of Website records of Approved Projects under this Act for Public View.<br/></br></p>
	
	<br/>
	<p>
	Please Login or Register to see the Project Details .<br/>
	
	Click here for
	 <a href="<%=request.getContextPath() %>/resources/staticpage/User Manual Public Domain.pdf" target="_blank">Public Domain User Manual</a> 
	</p>
	<br><br>
...
<form:form class="form-horizontal login" method="post" action="saveLoginDetails"  id="loginFormID" name="loginForm" autocomplete="off" >
