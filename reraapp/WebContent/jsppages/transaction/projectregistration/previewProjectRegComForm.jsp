				...
				<div class="border">
					...
					<div class="form-group">
						...
						<form:select path="promoterDetailsModel.typeOfPromoter" disabled="true"
								...
								<form:option value="Proprietorship Firm">Proprietorship Firm </form:option>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="file" id="regCertificateFile" name="regCertificateFile" disabled="disabled" Class="form-control"/>
...
<select class="form-control" name="chairManDistrictId"  id="District-chState"  disabled="disabled">
						...
						<option value='${dst.districtId }'> ${dst.districtName } </option>
							...
							<div class="col-sm-3 ">
								<input type="file" id="chairManPhoto" name="chairManPhoto" disabled="disabled" Class="form-control"/>
			...
			<div class="inner_wrapper">
				...
				<div class="border">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							...
							<form:input path="projectDetailsModel.totalAreaOfLand"  disabled="true"
								cssClass="form-control input-sm numericValFld  " />
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<form:input path="projectDetailsModel.estimatedCost" rel="txtTooltip" disabled="true"
								cssClass="form-control input-sm" />
						</div>
						...
						<div class="col-sm-3">
							<form:input path="projectDetailsModel.costOfLand" disabled="true" 
								cssClass="form-control input-sm " />
						</div>
						...
						<div class="col-sm-3">
							<form:input path="projectDetailsModel.totalProjectCost"  
...
<div class="inner_wrapper" id="prongonigsts" style="display: none;">
					...
					<h1>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								...
								<form:input type="text" path="projectDetailsModel.devCompletion"
									cssClass="form-control input-sm requiredValFld numericValFld" id="totalAmtClctedFrmAllotee" maxlength="2" title="e.g. Type of Flats/Plots/Villa etc." data-toggle="tooltip" data-placement="bottom" disabled="true"  />
							...
							<div class="col-sm-3">
								<form:input type="text" path="projectDetailsModel.devPending" disabled="true" rel="txtTooltip" maxlength="2" title="Only digits are allowed." data-toggle="tooltip" data-placement="bottom" 
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								...
								<form:input type="text" path="projectDetailsModel.totalAmtClctedFrmAllotee"
									cssClass="form-control input-sm requiredValFld numericValFld" disabled="true" id="totalAmtClctedFrmallottee"  title="e.g. Type of Flats/Plots/Villa etc." data-toggle="tooltip" data-placement="bottom"  />
							...
							<div class="col-sm-3">
								<form:input type="text" path="projectDetailsModel.totalAmtUsedInPrjct" rel="txtTooltip" title="Only digits are allowed." data-toggle="tooltip" data-placement="bottom" disabled="true"
									cssClass="form-control input-sm numericValFld numericValFld requiredValFld" id="noOfInventory" />
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<form:input type="text" path="projectDetailsModel.totalBalAmtOfAlte" disabled="true" cssClass="form-control input-sm   requiredValFld" rel="txtTooltip" title="Only digits are allowed." data-toggle="tooltip" data-placement="bottom" 
									id="carpetArea" />
                      ...
                      <div class="form-group">
						...
						<div class="col-sm-3">
                              ...
                              <form:input path="projectDetailsModel.reasonForDelayed"
									 cssClass="form-control input-sm  requiredValFld" disabled="true" />
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<form:input type="text" path="projectDetailsModel.estimatedEndDate" readonly="readonly" disabled="true" cssClass="form-control input-sm  augCalCssClass requiredValFld" />
								<span class="glyphicon glyphicon-calendar augCalImgCssClass"></span>
							...
							<div class="col-sm-3">
								    <input type="file" name="delayedCert" class="form-control" disabled="disabled" rel="txtTooltip" title="Only image or pdf file is allowed. file size upto 1 MB" data-toggle="tooltip" data-placement="bottom" />
					  ...
					  <tr>
					   ...
					   <tr>
					    <td>Auditor's Report<sup style="color:red;">*</sup> </td>
					     ...
					     <td><input type="file" disabled="disabled" class="form-control"  id="auditedBalFile" name="otherFileDoc" />
							<span class='requiredValFldMsg'> Please select Auditor Reports.</span>
...
<c:if test="${projectRegistrationModel.projectDetailsModel.isSubSqChangeInPlan=='Yes' }">
	 ...
	 <a href="download?DOC_ID=${projectRegistrationModel.projectDocModel.extendedSacPlanDoc.documentId}">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="file"  class="form-control" id="landDocumentsFile" name="otherFileDoc" disabled="disabled"/>
						...
						<div class="col-sm-3">
							<input type="file"  class="form-control" id="sanctionedLayoutPlan" name="otherFileDoc" disabled="disabled"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="file" class="form-control" id="areaDevelopmentPlanFile" name="otherFileDoc" disabled="disabled"/>
						...
						<div class="col-sm-3">
							<input type="file"  class="form-control" id="performaOfAllotmentLetterFile" name="otherFileDoc" disabled="disabled"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="file" class="form-control" id="brochureOfCurrentProjectFile" name="otherFileDoc" disabled="disabled"/>
						...
						<div class="col-sm-3">
							<input type="file" class="form-control"  id="projectRelatedDocumentsFile" name="otherFileDoc" disabled="disabled"/>
						...
						<label class="col-sm-2 control-label">Proforma For Sale Deed <sup>*</sup></label>
						<div class="col-sm-3">
							<input type="file" class="form-control" id="declarationFormb" name="otherFileDoc" disabled="disabled"/>
				...
				<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Declaration (Form B)<sup>*</sup></label>
						<div class="col-sm-3">
							<input type="file"  class="form-control" id="declarationFormb" name="otherFileDoc" disabled="disabled"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="file" class="form-control" id="advocatesearchreport" name="otherFileDoc" disabled="disabled"/>
					...
					<%if(pp==0){ %>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="file" class="form-control"  id="projectPhotoFile" name="projectPhotoFile" disabled="disabled"/>
