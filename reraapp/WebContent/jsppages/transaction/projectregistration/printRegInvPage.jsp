...
<form:form cssClass="form-horizontal" action="updateInvdPromoterDetails" modelAttribute="projectRegistrationModel" id="trxForm" autocomplete="off" enctype= "multipart/form-data">
    ...
    <div class="inner_wrapper">
				...
				<div class="border">
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-3 col-xs-3 control-label">PAN
							Number<sup>*</sup></label>
						<div class="col-sm-3 col-xs-3">
								 <form:input path="promoterDetailsModel.panNo" disabled="true" id="panNo" cssClass="form-control input-sm"/>	
					
						</div>
						<label for="inputEmail3" class="col-sm-2 col-xs-2 control-label">Aadhaar 
							Number<sup>*</sup></label>
						<div class="col-sm-3 col-xs-3">
					...
					<div class="form-group">
						...
						<label for="inputEmail3" class="col-sm-2 col-xs-2 control-label">Fax
							Number </label>
						<div class="col-sm-3 col-xs-3">
					...
					<div class="form-group">
						...
						<label for="inputEmail3" class="col-sm-3 col-xs-3 control-label">State/UT
						<sup>*</sup></label>
						<div class="col-sm-3 col-xs-3">
...
Branch: Gandhinagar<br/>
				...
				<div class="form-group">
					...
					<div class="col-sm-3 col-xs-3">
						<form:input path="paymentDetailsModel.paymentToken" cssClass="form-control input-sm" disabled="true"/>	
