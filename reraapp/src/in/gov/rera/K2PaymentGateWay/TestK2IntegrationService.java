...
import in.gov.rera.K2PaymentGateWay.service.impl.SignFile;

public class TestK2IntegrationService{
	...
	public static void main(String[] args) throws Exception {
		new TestK2IntegrationService().invokeK2PaymentGateway("reraUser", "2","ARC2WLTI03193","AGENT_REG");
	}
