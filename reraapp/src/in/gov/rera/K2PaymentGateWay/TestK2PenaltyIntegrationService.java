...
import in.gov.rera.K2PaymentGateWay.service.impl.PenaltySignFile;

public class TestK2PenaltyIntegrationService{
	...
	private static String DDO_CODE = "21141O";
	private static String DEPT_CODE = "19A";
	private static String DEPT_REF_NUM = "RERA";
	...
	private static String xmlFile2Send = k2ackLoc+"penalty_template.xml";

	private static boolean isSuccess = false;

	public static void main(String[] args) throws Exception {
		new TestK2PenaltyIntegrationService().invokeK2PaymentGateway("reraUser", "2","ARC2WLTI03193","AGENT_REG");
	}
	...
	private static String signDocument(byte[] b) throws IOException {
		...
		PenaltySignFile sf = new PenaltySignFile();
