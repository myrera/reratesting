...
@Service(value = "K2VerifyChallanService")
@Scope("request")
public class K2VerifyChallanServiceImpl implements IK2VerifyChallanService{
	...
	//private static String responseFileName = "/Users/tejomaya/Downloads/newsignresponse.xml";
	...
	public static void main(String[] args) throws Exception {
		System.out.println(new K2VerifyChallanServiceImpl().verifyChallan("RERT060718163207")); //change ref num
	}

	public Map<String, String> verifyChallan(String challanRefNum) throws Exception {
		...
		for (int count = 0; count < nodeList.getLength(); count++) {
			...
			if (tempNode.getNodeType() == Node.ELEMENT_NODE) {
				...
				if(tempNode.getNodeName().equals("deptRefNum")||tempNode.getNodeName().equals("bankName")
						...
						||tempNode.getNodeName().equals("pymntstatus")||tempNode.getNodeName().equals("currentTimeStamp"))
