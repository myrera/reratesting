...
public class SignFileForChalanVerification {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String filePath=k2ackLoc+"verifyChallan_template.xml";
			SignFileForChalanVerification sign=new SignFileForChalanVerification();
	...
	public String signDocument(InputStream is) {
		...
		File fileLoc=new File(k2ackLoc+"verifyChallan_template.xml");
