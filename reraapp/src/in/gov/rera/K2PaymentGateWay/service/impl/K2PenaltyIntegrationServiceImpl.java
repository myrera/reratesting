...
@Service(value = "K2PenaltyIntegrationService")
@Scope("request")
public class K2PenaltyIntegrationServiceImpl implements IK2PenaltyIntegrationService{
	...
	public static void main(String[] args) throws Exception {
		System.out.println(new K2PenaltyIntegrationServiceImpl().invokeK2PaymentGateway("reraUser", "2","ARC2WLTI03193","AGENT_REG"));
	}
